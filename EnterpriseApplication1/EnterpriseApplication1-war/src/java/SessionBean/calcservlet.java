...
public class calcservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           if(action.equals("divi")){
            out.println("<h1>DIVISIÓN = " + calcbean.division(a, b) + "</h1>");
            }
                      
           if(action.equals("eleva")){
           out.println("<h1>ELEVAR AL CUADRADO = " + calcbean.elevar(a,a) + "</h1>");
           }
           
           if(action.equals("modu")){
            out.println("<h1>MODULO = " + calcbean.modulo(a,a) + "</h1>"); 
            }
